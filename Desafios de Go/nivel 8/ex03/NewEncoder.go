...
//method channing :
// seria ao inves de utilizar uma variavel como intermediario eu utilizar uma variavel , eu posso ligar diretamente, o retorno de um metodo vai ser a entrada de outro metodo
/*
